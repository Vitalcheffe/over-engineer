...
Fluid dynamics of raindrops coalescing on a window. Over Engineer 06/12.
...
```bash
git clone https://github.com/Vitalcheffe/over-engineer-raindrops.git
cd over-engineer-raindrops
